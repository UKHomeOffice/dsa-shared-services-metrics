...
service_list = [
    {"name": "jra", "url": 'http://jira.shs-dev.dsa-notprod.homeoffice.gov.uk'},
    {"name": "cnf", "url": 'http://confluence.shs-dev.dsa-notprod.homeoffice.gov.uk'},
    {"name": "rkc", "url": 'http://rocketchat.shs-dev.dsa-notprod.homeoffice.gov.uk'}
    ]
dic_list = []
dic_item  = {}
#Setting log to STOUT
...
def write_to_json():
    ...
    try:
        ...
        for item in dic_list:
                ...
                f.write("dsa_"+item['name']+"_availability " +str(item['status'])+ "\n")
        f.close()
